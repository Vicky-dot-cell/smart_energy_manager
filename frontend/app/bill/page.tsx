...
export default function BillPage() {
    ...
    const handleProceed = () => {
        router.push(`/payment?amount=${bill?.totalDue}&method=${selectedMethod}`);
    };

    if (loading) {
        return (
            <DashboardShell>
                <div className="flex h-64 items-center justify-center text-gray-400">Loading bill...</div>
            </DashboardShell>
        );
    }
    ...
    if (!bill) {
        return (
            <DashboardShell>
                <div className="flex h-64 items-center justify-center text-red-400">Failed to load billing information.</div>
            </DashboardShell>
        );
    }
                    ...
                    <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
                        ...
                        <div className="flex justify-end">
                            <button
                                ...
                                className="bg-blue-600 hover:bg-blue-500 text-white font-semibold py-3 px-8 rounded-xl transition-colors disabled:opacity-50"
                            >
                                Proceed to Payment
                            </button>
                        </div>
