        ...
        <DashboardShell>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    {activeTab === 'security' && (
                        <div className="bg-neutral-900 rounded-xl shadow-sm border border-neutral-800 p-6">
                            <h3 className="text-lg font-semibold text-gray-100 mb-4 flex items-center gap-2"><Shield size={20} /> Security</h3>
                    ...
                    {activeTab === 'devices' && (
                        <div className="bg-neutral-900 rounded-xl shadow-sm border border-neutral-800 p-6">
                            <h3 className="text-lg font-semibold text-gray-100 mb-4 flex items-center gap-2"><Smartphone size={20} /> Connected Devices</h3>
                            <div className="space-y-4">
                                {devices.map(device => (
